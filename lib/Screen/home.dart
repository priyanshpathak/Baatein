...
import 'package:message/widget/all_wid.dart';
import 'package:message/models/ChatUser.dart';
import 'package:message/Providers/AuthProvider.dart';
import 'package:message/Providers/home_provider.dart';
import 'package:message/Screen/chat.dart';
import 'package:message/Screen/login.dart';
import 'package:message/Screen/profile.dart';
import 'package:message/util/debouncer.dart';
import 'package:message/util/keyboard_util.dart';
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.hasData) {
                          if ((snapshot.data?.docs.length ?? 0) > 0) {
                            ...
                            return const Center(
                              child: Text('Abhi koi hai hi nahi .....'),
                            );
                          }
                        } else {
                          return const Center(
    ...
    if (documentSnapshot != null) {
      ...
      if (userChat.id == currentUserId) {
        ...
        return TextButton(
            ...
            backgroundColor: AppColors.spaceLight,
            ),
          onPressed: () {
