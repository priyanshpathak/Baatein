...
import 'package:message/models/chat_messages.dart';
import 'package:message/Providers/AuthProvider.dart';
import 'package:message/Providers/chat_provider.dart';
import 'package:message/Screen/login.dart';
import 'package:url_launcher/url_launcher.dart';

import '../widget/common_wid.dart';
  ...
  Widget buildMessageInput() {
    return SizedBox(
      ...
      child: Row(
        children: [
          Container(
            margin: const EdgeInsets.only(right: Sizes.dimen_4,bottom: Sizes.dimen_4 ),
          ...
          Container(
            margin: const EdgeInsets.only(left: Sizes.dimen_4,bottom: Sizes.dimen_4),
            decoration: BoxDecoration(
              color: AppColors.orangeWeb,
              borderRadius: BorderRadius.circular(Sizes.dimen_30),
            ),
